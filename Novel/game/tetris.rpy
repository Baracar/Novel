    ...
    def draw_next(n):
        ...
        for cell in n:
            if cell:
                # O
                if n == [1,1, 1,1]:
                    t += '{image=Tetris/yellow.png}'
                # I
                elif n == [1,1,1,1, 0,0,0,0]:
                    t += '{image=Tetris/purple.png}'
                # J
                elif n == [1,0,0, 1,1,1]:
                    t += '{image=Tetris/blue.png}'
                # L
                elif n == [0,0,1, 1,1,1]:
                    t += '{image=Tetris/orange.png}'
                # S
                elif n == [0,1,1, 1,1,0]:
                    t += '{image=Tetris/green.png}'
                # Z
                elif n == [1,1,0, 0,1,1]:
                    t += '{image=Tetris/red.png}'
                # T
                elif n == [0,1,0, 1,1,1]:
                    t += '{image=Tetris/cyan.png}'
            else:
                t += '{image=Tetris/empty.png}'
...
screen draw_tetris():
    frame xysize 750,940 align .5,.5:
        ...
        frame xysize 35*row,35*column yalign .5 xalign .37:
            add 'Tetris/back.jpg' align .5,.5 size 35*row,35*column
