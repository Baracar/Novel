...
label table:
    "Миниигра по раскладыванию вещей на столе"
    $table = True
    call screen attic

label closet:
    "Миниигра по раскладыванию вещей в шкафу"
    $closet = True
    call screen attic

label poster:
    mc "О, это же поп-звезда Зухра Йолдыз. Не знал что подростковом возрасте папе такое нравилось. Внизу есть какая-то надпись… “Ай с тат. - месяц”. Постер вот-вот упадёт, нужно поправить."
    mc "Ой."
