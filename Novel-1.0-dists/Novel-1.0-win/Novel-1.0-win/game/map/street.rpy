...
label street:
    ...
    if first_visit_street == 0:
        ...
        mc "Я здесь ни разу не был. В этом доме жил отец с родителями, пока не вырос. Дедушки уже давно не стало, а бабушка умерла недавно и родители решили переехать в этот город обратно."
